<%-- 
    Document   : contactUs
    Created on : 09-Jan-2018, 15:00:12
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse yamm" id="navigation">
                    <ul class="main-nav nav navbar-nav navbar-right">
                        ...
                        <li class="wow"><a href="contactUs.jsp" class="dropdown-toggle active">Contact Us</a></li>
                    </ul>
                </div>
            </div>
        </nav>
                        ...
                        <div class="" id="contact1">                        
                            <div class="row">
                                <div class="col-sm-4">
                                    ...
                                    <p>Limerick Institute Of Technology
                                        <br>Moylish Park, 
                                        <br>Limerick, 
                                        <br>V94 EC5T, 
                                        <br><strong>Ireland</strong>
                                    </p>
                                </div>
                                <div class="col-sm-4">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <ul>
                                        <li><strong><a href="mailto:">information@lit.ie</a></strong></li>
                                    </ul>
                                </div>
                            </div>
                            <hr>
