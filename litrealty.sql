...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 01, 2018 at 03:18 PM
...
(4, 'Laura Blain', '444-5555', '555-6788', 'laura@homesellers.com'),
...
CREATE TABLE `garagetypes` (
  ...
  `garageName` varchar(20) DEFAULT NULL
...
INSERT INTO `garagetypes` (`garageId`, `garageName`) VALUES
(1, 'attached'),
(2, 'detached'),
(3, 'carport');
...
(32, '12 Mount Rochfort Close', 'Co. Dublin', 854605, 8, 1, 4, 1.5, 2000, 'B2', 'Hardwood trim throughout. This is a real gem. Three-seasons back porch, large yard, finished basement, and third-floor office make this a winner!', '80x120', 1, 2, 2, 7, '854605.JPG', 279900, '2018-01-09', 2),
...
--
-- Dumping data for table `properties_has_vendors_and_agents`
--

INSERT INTO `properties_has_vendors_and_agents` (`propertyId`, `agentId`, `vendorId`) VALUES
(1, 2, 2),
(2, 2, 6),
(3, 4, 7),
(4, 1, 9),
...
INSERT INTO `propertytypes` (`typeId`, `typeName`) VALUES
...
(1, 'Sue.Roberts', 'ba1e9ece69a4e16d16917e649d517226b9b6b282fbb912bb68fc69f24b80fe61'),
(2, 'Natasha.Watkins', 'c5365dd9e63a02ffb495b7ddfbf976cda085c7a3e7ba24a0ff3d256fcf5ecb8c'),
(3, 'Chris.Clarkson', '4cf9f10fd304dc885a78e29a95a77dd552ca15e168c06ad62f53830c1e19b929'),
(4, 'Laura.Blain', 'f828cbfdf7536d8b23219629263021785f4b48390c7f1cb47449418cff378e9d'),
(5, 'Dave.Lindale', 'c0ab909f6a88e98d9e6891da2013064cc99b51178689431ac2ea1ebcc4720eae'),
(6, 'Thaynara.Silva', 'd74ff0ee8da3b9806b18c877dbf29bbde50b5bd8e4dad7a3a725000feb82e8f1');
...
(7, 'Jackson Avery', '087-9185488', 'The Square Tubbercurry, Tubbercurry', 'Sligo', 'jackson@vendors.com'),
(8, 'Lena Luthor', '083-9833961', '44 Ballinalea, Ashford', 'Wicklow', 'lena@vendors.com'),
(9, 'Richard Webber', '085-2564288', 'Broughshane Rd., Ballymena', 'Antrim', 'richard@vendors.com'),
(10, 'Lexa Woods', '087-4580441', 'Gondola Main st, Newcastle', 'Kildare', 'lexa@vendors.com');
...
ALTER TABLE `properties`
  ...
  ADD KEY `property_type_fk` (`typeId`),
  ADD KEY `property_style_fk` (`styleId`),
  ADD KEY `garage_type_fk` (`garageId`),
  ADD KEY `agent_fk` (`agentId`);

--
-- Indexes for table `properties_has_vendors_and_agents`
--
ALTER TABLE `properties_has_vendors_and_agents`
