...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 24, 2018 at 05:22 PM
...
(6, 'Thaynara Silva', '555-1234', '555-0959', 'thay@homesellers.com');
...
(10, '35 Na Cluainte ', 'Portarlington', 141136, 2, 2, 3, 2, 1700, 'B2', 'Ideal for first time buyer/investor.This three bedroom semi detached property is located in quiet Na Cluainte estate which is off the Tullamore Road, close to GAA pitch, schools, church & walking distance to town centre. Viewing Highly Recommended.', '70x250', 2, 1, 1, 8, '141136.JPG', 203500, '2016-09-12', 9),
